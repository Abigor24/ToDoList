			...
			<MuiThemeProvider>
				<div className="App">
					<ConfirmDialog
						...
						message={'Вы действительно хотите удалить все задачи из приложения?'}
						onCancel={this.handleDialogClose}
						onConfirm={this.clearTasks}
						open={this.state.dialogOpen}
					/>
					<AppBar
						title={<span style={{color: 'white'}}>Список всех задач</span>}
					...
					<div className="App-container">
						<div style={{position: 'fixed', width: '100%', paddingTop: 64, zIndex: 8888, backgroundColor: 'white'}}>
							<TextField
								hintText="Впиши название"
								floatingLabelText="Вписать текст"
								ref={(taskInput) => {
